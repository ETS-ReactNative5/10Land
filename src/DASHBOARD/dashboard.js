...
class dashboard extends Component {
  ...
  async componentDidMount() {
    ...
    socket.on("SendApprovedata", async (data) => {
      ...
      if (data[0].approvedUser == Acc[0]) {
        ...
        axios
          .post("http://localhost:5000/Register/addNotification", finaldata)
          .then((res) => {
    ...
    var result = await LandAbi.methods
      .landInfoOwner(
        "0x7deddbeee2923bb35d0990c8f66cc70c7ebcfb6d756c63bc7b3abe44159adbf7"
      )
      .call();
  ...
  FetchNotification() {
    let su = 5;
    axios
      .get("/api/fetch/id=5") //chlo sirf dekhaney k lye
          ...
          <Container>
            <Navbar fixed="top" collapseOnSelect expand="xxl">
              ...
              <a
                ...
                className="makenote offset-md-9 offset-3"
              >
                <AiOutlineBell className={takebell} />
                <sup>{this.state.notificationLength}</sup>Notification
              </a>
              <span style={{ color: "white" }}> | </span>

              <div className="dropdown">
                <button className="dropbtnnn">
              ...
              <Row>
                <Col md={4}>
                  <Card style={{ width: "15rem" }}>
                    ...
                    />{" "}
                    <Card.Body>
                      <Card.Text>Connected Users {this.state.Count} </Card.Text>
                    </Card.Body>{" "}
                  </Card>{" "}
                </Col>
                ...
                <Col md={4}>
                  ...
                  <Card style={{ width: "15rem" }}>
                    ...
                    <Card.Body>
                      <Card.Text>What is BlockChain ?</Card.Text>
                    </Card.Body>
                  </Card>
                </Col>
                ...
                <Col md={4}>
                  ...
                  <Card style={{ width: "15rem" }}>
                    ...
                    />{" "}
                    <Card.Body>
                      <Card.Text>How it Works!</Card.Text>
                    </Card.Body>{" "}
                  </Card>
                </Col>
              </Row>
