...
class adminbackdraw extends Component{
...
var sanaa= await LandAbi.methods.viewapprover(this.props.click2).call({from: Acc[0]});
console.log("sanaa",sanaa);
await this.setState({admindetail: sanaa});
    let location= this.state.admindetail[1]+" " + "Saudi Arabia";
...
<Modal  show={this.state.showsign}  className=" setLogin" >
        ...
        <Col>City {this.state.admindetail[1]} </Col>
         <br></br>
         PhoneNo: {this.state.admindetail[0]}
         <br></br>
